...
(* OASIS_START *)
(* DO NOT EDIT (digest: 01347f706201fb763f9db0f967b81d86) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mirleft/ocaml-asn1-combinators";
          synopsis = "Combinators for expressing ASN.1 grammars in OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "Express ASN.1 grammars directly in OCaml, combinator-style, then use them to parse or encode."
              ];
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "asn1-combinators";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\003xg\188\000\175CQ\240\217\212\154_1\127\173";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
